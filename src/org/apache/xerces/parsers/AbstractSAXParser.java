              ...
              Parser, XMLReader // SAX1, SAX2
{
    ...
    protected static final class LocatorProxy
        ...
        public int getCharacterOffset() {
        	if ( fLocator instanceof XMLLocatorWrapper ) {
        		XMLLocatorWrapper w = ( XMLLocatorWrapper )fLocator;
        		XMLLocator real = w.getLocator();
        		if ( real instanceof XMLEntityScanner ) {
        			XMLEntityScanner sc = ( XMLEntityScanner )real;
        			return sc.getCharacterOffset();
        		}
        	}
        	return 0;
        }
