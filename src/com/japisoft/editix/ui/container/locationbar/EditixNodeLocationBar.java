...
public class EditixNodeLocationBar extends JComponent 
	...
	private EditixNodeLocationBar() {

		LIGHT = UIManager.getColor( "editix.nodelocation.color" );
		DARK = UIManager.getColor( "editix.nodelocation.dark" );
		...
		if ( ( hierarchy != null ) && 
			...
			for ( int j = 0; j < hierarchy.size(); j++ ) {
				...
				if ( ( currentMouseX >= rx && currentMouseX <= ( rx + rw ) ) && 
					...
					g.drawLine( rx, ry + rh - 1, rx + rw, ry + rh - 1 );
				}
