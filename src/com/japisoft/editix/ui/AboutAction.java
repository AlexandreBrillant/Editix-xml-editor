...
public class AboutAction extends AbstractAction {
	...
	public void actionPerformed( ActionEvent e ) {
		...
		String message = "EditiX XML Editor - Open source edition for non commercial usage";
		...
		AboutDialog.showDialog(
			...
			"http://www.editix.com",
			"images/logo.png",
			"This open source version is only for non commercial usage or commercial owner license",
			message 
		);
	}
