...
import com.japisoft.framework.xml.refactor2.elements.DeleteText;
...
*/
public class RefactorDeleteTextAction extends FormatAction {
	...
	protected AbstractRefactor getRefactor() {
		...
		if ( !EditixFactory.buildAndShowConfirmDialog( "Delete the text inside the elements '" + oldValue + "' ?" ) )
			throw new RuntimeException( "" );

		DeleteText re = new DeleteText();
