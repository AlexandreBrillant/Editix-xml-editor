...
import com.japisoft.framework.xml.refactor2.elements.InsertElement;
import com.japisoft.framework.xml.refactor2.elements.InsertText;
...
*/
public class RefactorInsertTextAction extends FormatAction {
	...
	protected AbstractRefactor getRefactor() {
		...
		String newValue = 
			EditixFactory.buildAndShowInputDialog( "Insert this text" );
		if ( newValue == null ) {
			throw new RuntimeException( "" );
		}
		
		InsertText re = new InsertText();
