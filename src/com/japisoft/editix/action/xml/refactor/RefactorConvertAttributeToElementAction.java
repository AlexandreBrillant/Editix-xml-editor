...
import com.japisoft.framework.xml.refactor2.elements.ConvertAttributeToElement;
...
*/
public class RefactorConvertAttributeToElementAction extends FormatAction {
	...
	protected AbstractRefactor getRefactor() {
		...
		if ( !EditixFactory.buildAndShowConfirmDialog( "Convert the attribute '" + oldValue + "' to element ?" ) )
			throw new RuntimeException( "" );

		ConvertAttributeToElement re = new ConvertAttributeToElement();
