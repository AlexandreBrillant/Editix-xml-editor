...
*/
public class RefactorInsertElementAction extends FormatAction {
	...
	protected AbstractRefactor getRefactor() {
		...
		String newValue = 
			EditixFactory.buildAndShowInputDialog( "Insert this element name" );
		if ( newValue == null ) {
		...
		InsertElement re = new InsertElement();
