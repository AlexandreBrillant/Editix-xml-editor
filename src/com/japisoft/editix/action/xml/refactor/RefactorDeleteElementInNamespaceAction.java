...
import com.japisoft.framework.xml.refactor2.elements.DeleteElementInNamespace;
...
*/
public class RefactorDeleteElementInNamespaceAction extends FormatAction {
	...
	protected AbstractRefactor getRefactor() {
		...
		String oldValue = element.getNameSpaceURI();

		if ( !EditixFactory.buildAndShowConfirmDialog( "Delete all the elements in the namespace " + oldValue + " ?" ) )
			throw new RuntimeException( "" );

		DeleteElementInNamespace re = new DeleteElementInNamespace();
