...
public class CSVImport extends AbstractAction {
	...
	public void actionPerformed(ActionEvent e) {
		...
		if ( Manager.isFree() ) {
			...
			File csvFile = FileManager.getSelectedFile( true, new String[] { "csv", "xlsx" }, new String[] { "CSV File", "Excel file" } );
			
			if ( csvFile != null ) {
				
				CSVPanel confImport = new CSVPanel();				
				confImport.setExcelMode( FileToolkit.matchExt( csvFile, "xlsx" ) );
				
				if (DialogManager.showDialog(EditixFrame.THIS, "CSV Import",
						"CSV Import", "Import a Spreadsheet (csv,xlsx...) document to XML", null,
