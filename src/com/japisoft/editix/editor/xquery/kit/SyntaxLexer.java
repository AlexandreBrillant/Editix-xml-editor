...
public class SyntaxLexer {
	...
	SyntaxLexer() {
		...
		if ( EditixApplicationModel.DARK_MODE ) {
			...
			string1Color = Preferences.getPreference( "editor", "dark-attribute", Color.WHITE );		
			string2Color = Preferences.getPreference( "editor", "dark-attribute", Color.WHITE );
			c = Preferences.getPreference( "editor", "dark-tag", Color.WHITE );
			commentColor = Preferences.getPreference( "editor", "dark-comment", Color.WHITE );
			tagColor = Preferences.getPreference( "editor", "dark-tag", Color.WHITE );
		}
