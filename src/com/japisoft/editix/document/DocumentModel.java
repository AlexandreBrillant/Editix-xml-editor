...
/**
 * Main a collection of XMLDocument
	...
	static XMLDocumentInfo buildDocument( FPNode n ) {
		...
		while (enume.hasMoreElements()) {
			...
			if ("true".equals(__.getAttribute("def"))) {
				String _tmp = null;
				info.setDefaultFileExt(_tmp = __.getAttribute("name"));
			}
		}
		...
		if (enume.hasMoreElements()) {
			...
			if (location != null) {
				...
				info.setDefaultDTD(__.getAttribute("root"), location);
		...
		if (enume.hasMoreElements()) {
			...
			if (location != null) {
				...
				info.setDefaultSchema(__.getAttribute("root"), location);
			}
		}
		...
		FPNode draggNode = tw.getFirstTagNodeByName( "fileDragging", false );
		if ( draggNode != null ) {
			info.setFileDraggingClass( draggNode.getAttribute( "class" ) );
		}
