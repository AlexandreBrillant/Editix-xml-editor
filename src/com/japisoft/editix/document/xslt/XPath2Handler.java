...
*/
public class XPath2Handler extends AbstractHelperHandler {
	...
	protected void installDescriptors(
		...
		String[] raws = Keywords.raw_functions;
		for ( int i = 0; i < raws.length; i++ ) {
			addDescriptor( new BasicDescriptor( raws[ i ] ) );
		}
