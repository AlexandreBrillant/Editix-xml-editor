 ...
 * stored inside the<code> WizardStepModel</code>. Each step
 * implements the <code>WizardStep</code> interface for controlling the 
 * wizard part behavior and look.
 * <p>UIManager properties :
 * - com.japisoft.jwizard.labelbg : Background color for the label steps
 * - com.japisoft.jwizard.image : Image for the label steps </p>
 * <p>Key for the JWizard.properties resource bundle :
 * - STEPS : Steps title
 * - STEP : Step title
