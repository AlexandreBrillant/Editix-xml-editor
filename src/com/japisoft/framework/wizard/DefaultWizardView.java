...
/**
 * This is a simple view of your wizard. Most of the user will not have need to
 * create a complete new WizardView and will have to create a child class from
 * this one
 * 
