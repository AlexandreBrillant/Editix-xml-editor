...
public class FastVector implements Cloneable {
	 ...
	 * capacity of the vector is the length of this array buffer.
	 *
	 * @since JDK1.0
	 */
	 ...
	 * <code>0</code>, the capacity of the vector is doubled each time it needs to
	 * grow.
	 *
	 * @since JDK1.0
	 */
	...
	/**
	 * This implements the unsynchronized semantics of ensureCapacity. methods in
	 * this class can internally call this method for ensuring capacity without
	 * incurring the cost of an extra synchronization.
	 *
	 ...
	 * size, new <code>null</code> items are added to the end of the vector. If the
	 ...
	 * at <code>index</code>, and testing for equality using the <code>equals</code>
	 * method.
	 *
	 * @param elem  an object.
	 * @param index the index to start searching from.
	 * @return the index of the first occurrence of the object argument in this
	 *         vector at position <code>index</code> or later in the vector; returns
