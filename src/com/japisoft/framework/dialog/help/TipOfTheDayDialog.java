...
/**
 * Display in a dialog box available tips from the default tips/ directory classpath. Each time is an
 * HTML page. The first like of each tip is the title of the tip. 
