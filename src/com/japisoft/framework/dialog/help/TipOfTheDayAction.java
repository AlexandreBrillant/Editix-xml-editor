...
public class TipOfTheDayAction extends AbstractAction {
	...
	public void actionPerformed(ActionEvent e) {
		TipOfTheDayDialog dialog = new TipOfTheDayDialog(
				Preferences.getPreference( "interface", "tipOfTheDay", true) );
		dialog.setSize( 480, 200 );
		Toolkit.center( dialog );
		dialog.setVisible( true );
		//dialog.dispose();
//		Preferences.setRawPreference( "interface", "tipOfTheDay", new Boolean( dialog.isAvailableForTheNextTime() ) );
	}
