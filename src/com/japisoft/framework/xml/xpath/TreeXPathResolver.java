...
package com.japisoft.framework.xml.xpath;

import java.util.Stack;

import com.japisoft.framework.xml.xpath.node.*;
...
public final class TreeXPathResolver implements XPathResolver {
	...
	public void number(String number) {
		com.japisoft.framework.xml.xpath.node.Number n = new com.japisoft.framework.xml.xpath.node.Number();
		n.setNumber(number);
		nodeStack.push(n);
	}
	...
	public void unaryOperator( int type ) {
		...
		if ( type == XPathResolver.MINUS ) {
			...
			if ( exp1 instanceof com.japisoft.framework.xml.xpath.node.Number ) {
				com.japisoft.framework.xml.xpath.node.Number n = (com.japisoft.framework.xml.xpath.node.Number)exp1;
