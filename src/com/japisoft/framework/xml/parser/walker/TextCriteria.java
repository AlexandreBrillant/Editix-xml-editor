...
*/
public class TextCriteria implements ValidCriteria {
    private String text;
	...
	return node.isText() && ( text == null || ( node.getContent() != null && node.getContent().indexOf( text ) > -1 ) );
    }

}

// NodeNameCriteria ends here
