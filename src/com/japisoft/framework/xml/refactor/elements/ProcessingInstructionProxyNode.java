...
*/
public class ProcessingInstructionProxyNode implements ProcessingInstruction {
	private ProcessingInstruction ref;
	private String newName;
	
	public ProcessingInstructionProxyNode( 
			ProcessingInstruction ref, 
			String newName ) {
		this.ref = ref;
