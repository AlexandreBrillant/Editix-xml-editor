 ...
 * @version 1.0
 */
public class JSXUI extends AbstractTaskUI implements ActionListener {
	...
	public static final String JSX = "JavaScript";
	...
	FileTextField tfSourcePath = new FileTextField(null, new String[] { "xml" } );

	JLabel lblSourceFilter = new JLabel();

	JComboBox cbSourceFilter = XFlowsFactory.getSourceFilter("jsx");

	JLabel lblXSLTPath = new JLabel();

	FileTextField tfStylesheetPath = new FileTextField(null, "jsx");
	...
	public JSXUI() {
		...
		try {
			...
			tfTargetPath.setEnabled( false );
			cbTargetName.setEnabled( false );
	...
	void jbInit() throws Exception {
		...
		lblXSLTPath.setText("JavaScript path");
