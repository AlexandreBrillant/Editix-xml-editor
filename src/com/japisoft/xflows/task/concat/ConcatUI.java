...
*/
public class ConcatUI extends AbstractTaskUI {
	...
	JLabel lblRootTag = new JLabel( "Root tag" );
	FileTextField tfTargetPath = new FileTextField(null, ( String )null);
	JTextField tfRootTag = new JTextField();
	...
	void jbInit() throws Exception {
		titledBorder1 = new TitledBorder(BorderFactory.createLineBorder(
				new Color(153, 153, 153), 2), "Concat XML");
		...
		this.add(lblRootTag, new GridBagConstraints(0, 3, 1, 1, 0.0, 0.0,
				GridBagConstraints.WEST, GridBagConstraints.NONE, new Insets(
						18, 17, 0, 31), 0, 0));

		this.add(tfRootTag, new GridBagConstraints(1, 3, 1, 1, 1.0, 0.0,
				GridBagConstraints.WEST, GridBagConstraints.HORIZONTAL,
				new Insets(14, 9, 0, 14), 434, 4));		
