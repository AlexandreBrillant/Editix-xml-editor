...
public class DocBookUI extends AbstractTaskUI {
	...
	JComboBox cbSourceFilter = XFlowsFactory.getSourceFilter( "docbook" );
	...
	JComboBox cbTargetName = XFlowsFactory.getTargetName( "docbook" );
	...
	void jbInit() throws Exception {
		titledBorder1 = new TitledBorder(
				BorderFactory.createLineBorder(
						new Color( 153, 153, 153 ), 2 ), "DocBook" );
		lblSource.setText("DocBook Source path");
		this.setBorder(titledBorder1);
		this.setLayout(gridBagLayout1);
		tfSourcePath.setText("");
		lblSourceFilter.setText("DocBook Source filter");
