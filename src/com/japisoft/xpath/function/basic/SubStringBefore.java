...
*/
public final class SubStringBefore extends AbstractFunction {
    ...
    public Object eval( XPathContext context, FastVector arg ) {
      if ( arg.size() != 2 )
        throw new RuntimeException( "Invalid function usage for substring-before" );

	java.lang.String s1 = getString1( context, arg );
	java.lang.String s2 = getString2( context, arg );
	int i = s1.indexOf( s2 );
	if ( i == -1 )
	    return "";
