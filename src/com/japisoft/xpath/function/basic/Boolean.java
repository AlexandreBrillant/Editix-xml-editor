...
*/
public final class Boolean extends AbstractFunction {
    public Boolean() {
	super();
    }
	...
	Object obj = arg.elementAt( 0 );
	if ( obj instanceof java.lang.Boolean )
	    return obj;
	if ( obj instanceof Double )
	    return new java.lang.Boolean( ( (Double)obj ).intValue() != 0 );
        if ( obj instanceof NodeSet )
            return new java.lang.Boolean( ( ( NodeSet )obj ).size() > 0 );
	java.lang.String s = context.getStringValue( obj );
	return new java.lang.Boolean( s.length() > 0 );
    }
