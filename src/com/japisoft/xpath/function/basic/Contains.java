...
*/
public final class Contains extends AbstractFunction {
    public Contains() {
	super();
    }
    ...
    public Object eval( XPathContext context, FastVector arg ) {
      if ( arg.size() != 2 )
        throw new RuntimeException( "Invalid usage for function contains" );
	return new java.lang.Boolean( getString1( context, arg ).indexOf( getString2( context, arg ) )  > -1 );
    }
}
