...
*/
public final class StartsWith extends AbstractFunction {
    ...
    public Object eval( XPathContext context, FastVector arg ) {
      if ( arg.size() != 2 )
        throw new RuntimeException( "Invalid function usage for starts-with" );
      java.lang.String param1 = getString1( context, arg );
      java.lang.String param2 = getString2( context, arg );
      return new java.lang.Boolean( param1.startsWith( param2 ) );
    }
