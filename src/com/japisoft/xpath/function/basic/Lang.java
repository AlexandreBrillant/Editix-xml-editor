...
public final class Lang extends AbstractFunction {
	...
	checkOneString( arg );
	java.lang.String s = ( java.lang.String )arg.elementAt( 0 );
        s = s.toLowerCase();
        java.lang.String lang = context.getLang( context.getNodeFromContext() );
        if ( lang != null ) {
          lang = lang.toLowerCase();
          if ( lang.startsWith( s + "-" ) )
            return new java.lang.Boolean( true );
          else
            return new java.lang.Boolean( s.equals( lang ) );
        } else
