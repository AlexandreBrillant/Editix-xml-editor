...
public class SurroundCDATAAction extends XMLActionForSelection {
	...
	public boolean notifyAction() {
		...
		if (selection != null) {
			if ( selection.indexOf( "<![CDATA" ) > -1 ) {
				JOptionPane.showMessageDialog( container.getView(), "Remove the current CDATA part before operating", "Error", JOptionPane.ERROR_MESSAGE );
				return false;
			}			
			container.getEditor().replaceSelection( "<![CDATA[" + selection + "]]>" );
			return true;
		} else {
			return false;
		}
